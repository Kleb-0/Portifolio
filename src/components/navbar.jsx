...
export default function NavBar() {
  const glowEffect =
    "hover:!text-violet-700 hover:shadow-violet-500 hover:shadow-sm rounded-sm !p-1";
  return (
    <div className="h-20 text-zinc-950 bg-zinc-100 flex items-center shadow-zinc-400 shadow-lg">
